...
public class CheckCard2 {
	// 멤버 변수
	/*
	 정보은닉이랑 멤버변수를 private으로 선언하여
	 클래스 외부에서는 접근하지 못하게 차단한다.
	 */
	...
	// 초기화메서드
	/*
	 생성자가 아닌 일반적인 멤버메서드를 만들때는 무조건 public void를 붙여놓고 시작한다.
	 차후 반환타입이 있는경우 void를 해당 반환타입으로 변경하면 된다.
	 */
	...
	/*
	 멤버변수를 private으로 선언하면 클래스 내부에서만 접근할 수 있음으로
