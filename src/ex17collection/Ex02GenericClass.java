...
/*
 class FruitBox{
	...
	public Object pullOut() {
	 ...
	 자료형에 해당하는 부분을 타입매개변수 <T>로 교체하고
	 객체 생성시 자료형을 결정하기 위해 클래스명<자료형> 형태로 기술한다.
 */
...
public class Ex02GenericClass {
	public static void main(String[] args) {
		/*
		 인스턴스 생성시 T부분을 결정함으로 구현의 편의성이 보장된다.
		...
		/*
		 OrangeBox는 인스턴스 생성시 Orange를 저장할 수 있는 용도로 생성되었다.
		 그렇기 때문에 다른 객체는 저장할 수 없다.
		 아래 코드에서 컴파일 에러가 발생함으로 자료형에도 안전한 코드가 된다.
		 */
