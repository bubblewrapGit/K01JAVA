...
class Circle{	
	...
	//블라블라
	public Circle(int cicleX, int cicleY, int cicleH) {
		radian = cicleH;
		center = new Point(cicleX, cicleY);
	}
...
class Ring{
	...
	//블라블라
	public Ring(int cicle1x, int cicle1y, int cicle1h, int cicle2x, int cicle2y, int cicle2h) {
		innerCircle = new Circle(cicle1x, cicle1y, cicle1h);
		outerCircle = new Circle(cicle2x, cicle2y, cicle2h);
	}
	void showRingInfo() {
