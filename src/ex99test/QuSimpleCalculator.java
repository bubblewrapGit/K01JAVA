...
class CalculatorEx{
	int  addRoutine, minRoutine, mulRoutine, divRoutine;
	...
	public double min(double firstNum, double secondNum){
		minRoutine++;
	...
	public void showOpCount(){
		System.out.println("덧셈횟수 : " + addRoutine);
		System.out.println("뺄셈횟수 : " + minRoutine);
		System.out.println("곱셈횟수 : " + mulRoutine);
		System.out.println("나눗횟수 : " + divRoutine);
	}
