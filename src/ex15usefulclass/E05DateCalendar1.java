...
public class E05DateCalendar1 {
	...
	public static String[] myDiffDate() throws ParseException{
		...
		1~10자리 까지는 순수한 초이고, 11~13자리 까지는 밀리세컨즈를 의미한다.
		...
		long diffDays = diffSec / (24*60*60); // 하루는 86400초임으로 나눠서 일수를 계산한다.
	...
	public static void main(String[] args) throws ParseException{
		...
		// Calendar클래스는 대표적인 싱글톤임으로 new로 생성하지 않는다.
