...
/*
 Wrapper 클래스
 	: 기본자료형의 데이터를 인스턴스화(객체화)할 때 사용하는 클래스로
 	  Boxing 혹은 Unboxing을 통해 기본자료를 객체화한다.
 */
public class E01WrapperClass1 {
	public static void main(String[] args) {
		...
		기본자료형을 박싱 처리한 객체에 대한 산술연산을 진행할 때는
		다시 언박식을 위해 intValue()와 같은 메서드를 호출해야 한다.
		*/
		Integer n100bj = new Integer(10);	// 현재는 이와 같은 생성자는 
		Integer n200bj = new Integer(num2); // Deprecated(디플리케이티드) 되었다.
		...
		오토박싱 혹은 오토언박싱이 지원됨으로
		기본자료형 변수를 선언하는 것과 동일하게 기술할 수 있다.
		 */
		Integer numObj1 = 100;
		Integer numObj2 = 200;
		int num3 = numObj1;
		...
		/*
		 Wrapper 클래스를 통해 진법변환이나 해당 자료형의 최대/최소값을 알 수 있다.
		 */
