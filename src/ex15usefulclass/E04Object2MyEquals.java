...
/*
 ...
 - 자바에서 인스턴스의 내용비교를 위해 비교연산자(==)를 사용하는 것은
 	단순히 참조값에 대한 비교임으로, 실제 내용에 대한 비교는 이루어지지 않는다.
 - 인스턴스 간의 내용비교를 위해서는
 	equals()메소드를 각 클래스에 맞게 오버라이딩하여 사용해야한다.
...
class IntNumber{
	...
	/*
	 equals()메서드가 어떻게 인스턴스 간의 내용을 비교하는지
	 설명하기 위한 코드로 구성됨.
	 */
...
public class E04Object2MyEquals {
	public static void main(String[] args) {
		...
		// String과 같은 기본클래스는 별도의 오버라이딩 없이 내용비교 가능함.
