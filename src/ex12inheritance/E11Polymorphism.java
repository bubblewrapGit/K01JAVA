...
//		parent1.childMember = 1;  // 접근불가 -> 부모타입으로 자식멤버에 접근할 수 없다.
		parent1.parentMethod(); // 오버라이딩 한 메서드임으로 자식쪽이 호출된다.
		...
		// 자식쪽 멤버에 접근하는 방법2 : 자식타입의 참조변수에 할당한 후 접근한다.
		...
		/*
		 ...
		 따라서 모든 객체는 Object의 참조변수로 참조 가능하다.
		 또한 Object클래스에 정의된 모든 메서드를 별도의 선언없이 사용할 수 있다.
		 */
