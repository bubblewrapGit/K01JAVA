...
/*
 멤버변수가 상속관계에 있다 하더라도 private 으로 선언되면
 클래스 내부에서만 접근할 수 있다.
...
class Account {
	...
	/*
	 입금처리 : protected로 선언되었음으로 상속관계에서 접근가능
	 */
...
class SavingAccount extends Account{
	...
	public void showAccountMoney() {
		/*
		 private 멤버변수인 money는 자식쪽으로 직접 접근할 수 없음으로
...
public class E02PrivateInheritanceMain {
	public static void main(String[] args) {
		...
		/*
		 private멤버임으로 상속받은 하위클래스의 참조변수를 통해서는
		 접근할 수 없다.
		 은닉된 정보임으로 'not visible'이라는 에러 메시지를 볼 수 있다.
		 */
//		sa.money = 100000; // [에러] 접근불가. 
		sa.saveMoney(5000);
		sa.showAccountMoney();
