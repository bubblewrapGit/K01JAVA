...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		System.out.println("int1 + int2 = " + result1); // int1 + int2 = 300
		
		
		/*
		 정수와 정수를 연산하면 정수의 결과가 나온다.
		 '/' 연산자는 두 정수를 나눠서 몫을 구하는 연산자이므로
		   결과는 0이 나온다.
		 */
		result1 = int1 / int2;
		...
		/*
		 ...
		 - byte, short형은 게임 캐릭터의 움직임이나 음원 정보등을 표현할 때 주로
		   사용된다.
		 */
		...
		/*
		 - 동일자료형끼리의 연산은 동일자료형이 되는 것이 기본원칙이다.
		 - 하지만 큰 자료형과 작은 자료형을 연산하면 큰 자료형으로 자동형변환된다.
		  	(이유는 데이터의 손실이 있을 수 있기 때문이다)
		 - 단, byte형과 short형은 예외적인 상황으로 생각하면 된다. int형에 최적화된 CPU의 특성 때문이다.
		 */
		long long1 = 1000, long2 = 2000;
		long result4 = int1 + long1; // int + long => long ex)작은자료형 + 큰자료형 = 큰자료형
		...
		/*
		 ...
		 하위 정수를 메모리에 올리는 순간 에러가 발생함.
		 이떄 접미사(l or L)을 붙여서 int형 자료가 아닌 long형 자료임을 알림.
		 이와같이 대입을 위해 입력되는 숫자도 자료형을 기반으로 메모리에 저장되고,
		 이를 '★리터럴'이라고 한다.
		 */
		// long long3 = 2200000000; => 에러발생됨.
		long long4 = 2200000000L; // 접미사를 붙여야
