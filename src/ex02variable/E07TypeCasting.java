...
//		char ch1 = b1; //에러발생
		...
		/*
		 명시적 형변환 : 큰 상자의 자료를 작은상자의 자료형에 할당해야할때 사용.
		 	단, 자료의 손실이 있을 수 있음.
		 		필료한 경우에만 사용.
		 */
		short s2 = 100;
		...
		/*
		 소수점 아래부분이 버려짐으로 데이터 손실이 있는 경우이다.
		 따라서 특수한 경우가 아니라면 사용에 주의해야함.
		 */
		int num3;
		double dl = 3.14;
		num3 = (int)dl;
