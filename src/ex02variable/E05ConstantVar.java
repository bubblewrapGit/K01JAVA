...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 상수는 딱 한번만 초기화되고, 중간에 값을 변경하면 에러 발생됨
		 - 선언시 전체를 대문자로 선언하고, 연결되는 단어가 있는경우
		 	_(언더바)를 사용한다.
		 - 주로 프로그램에서 코드의 가독성을 높혀주기 위해 활용된다.
		 */
...
//		System.out.println("우리는 "+ NICK_NAME);
		...
		/*
		 1과 3은 개발자 본인만 알 수 있는 내용이므로, 가독성이 떨어지는 코드로 작성됨.
		 만약 다른 개발자가 해당 코드를 본다면 확인절차를 걸쳐야 할 것이다.
		 */
