 ...
 * 	  그래서 다른 메소드(지역)에서 값의 변경이 있더라도
 * 	  호출한 메소드의 값에는 전혀 영향을 미치지 않는다.
 * 
 * 	  메모리적 관점에서 보면 스택영역만 사용하는 케이스로 
 * 	  main과 호출된 메서드는 서로 다른 지역이므로
 *	  서로에게 영향을 미치지 않는 것이 특징이다.
 */
public class E03CallByValue
{
	public static void main(String[] args)
	{
		...
		System.out.println("[main메소드안-호출전]" + "first=" + first
				+", second=" + second);
	...
	{
		/*
		 * Swap(교환) : 두개의 변수가 할당받은 값을 서로 교환하는 것
		...
		System.out.println("[callByValue메소드안]" + "fist=" + fNum 
				+ ", second=" + sNum);
	}
}
