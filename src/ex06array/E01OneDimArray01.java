...
public class E01OneDimArray01
{
	public static void main(String[] args)
	{
		...
		/*
		 * 배열의 선언과 동시에 초기화를 하는경우
		 * 자바 컴파일러는 초기값의 갯수를 통해 크기를 결정할 수 있다.
		 * 따라서 이런 경우 크기는 생략하도록 약속되어있다.
		 */
		...
		int[] initArr3 = {11, 13, 17, 19, 23}; // 요소의 갯수를 통해 크기 5 지정
		int arrSum = 0;
		// 요소의 갯수만큼 루프되면서 각 요소를 누적하여 더함
