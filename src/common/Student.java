...
public class Student extends Person {
	...
	public String getInfo() {
		/*
		 부모에서 정의한 getInfo()를 통해 이름, 나이까지의 문자열을 반환받은 후 
	...
	/*
	 hashCode() : 객체가 가진 고유한 주소값을 정수형으로 반환해준다.
	 	Set컬렉션에 저장시 중복확인을 위한 첫번째 오버라이딩 해야할 메서드이다.
	 */
	@Override
	public int hashCode() {
	...
	public boolean equals(Object obj) {
		...
		System.out.println("equals()에서드 호출됨");
		// 학번에 대한 비교를 진행
	...
	public String toString() {
		return "Student [stNumber=" + stNumber + ", 이름=" + getName() + ", 나이=" + getAge() + "]";
	}
