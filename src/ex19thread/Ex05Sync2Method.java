...
class SumMulti2{
	...
	/*
	 ...
	 코드 실행시간이 훨씬 더 길어지게 되는 단점이 있다.
	 
	 즉, 동기화는 성능의 감소를 초개함으로
	 필요한 부분에 대해서만 동기화 처리해주는 것이 좋다.
	 메서드 전체를 동기화 하는 방법(1)과 필요한 코드만 동기화 하는 방법(2) 두가지 방법이 있다.
	 */
	// 동기화방법1 : 동기화 메서드
//	synchronized public void addNum(int n) {
//		num += n;
//	}
	// 동기화방법2 : 동기화 블럭 (★딱 필요한 부분만 동기화블럭하기 성능up/효율up!!!)
